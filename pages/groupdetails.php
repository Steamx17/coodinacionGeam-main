...
$idGrupo = $_GET['id_group'];
$group = findGroup($idGrupo);
...
<head>
  ...
  <title>Detalles de grupo | GEAM</title>
          ...
          <div class="col-md-12">
            ...
            <div class="card">
              <div class="card-header">
                <h3 class="card-title">Alumnos registrados en el grupo <?php echo $group['name_group']; ?></h3>
              </div>
              <!-- /.card-header -->
              <div class="card-body">
                <table id="example1" class="table table-bordered table-striped">
                  ...
                  <tbody>
                    <?php foreach ($studentsxgroup as $studentsxgroup) : ?>
                      <tr>
